...
- 1. wide/messy data into long/tidy data using the `gather()` function in the `tidyr` package
- 1. long data into wide data using the `spread()` function in the `tidyr` package
