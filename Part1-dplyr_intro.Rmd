...
- 1. choose subsets of data using the `filter()` verb
- 1. aggregate data to create summaries using the `summarize()` and `group_by` verbs
- 1. make new variables using the `mutate()` verb
- 1. sort your data frames using the `arrange()` verb